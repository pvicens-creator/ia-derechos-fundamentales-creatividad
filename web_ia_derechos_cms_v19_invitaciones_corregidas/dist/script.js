...
(function () {
  ...
  const privateMode = Boolean(userLabel || logoutButton);
  ...
  // En producción pública, el widget queda disponible únicamente para
  // completar invitaciones, recuperaciones y confirmaciones recibidas por email.
